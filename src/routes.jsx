...
const Thermostat = React.lazy(() => import("./Pages/Thermostat"));
...
const routes = [
  ...
  { path: "/", exact: true, name: "Thermostat", component: Thermostat },
  { path: "/thermostat", exact: true, name: "Thermostat", component: Thermostat },
